...
# -*- coding: utf-8 -*-
#
# simpleschema documentation build configuration file, created by
...
version = simpleschema.__version__
...
htmlhelp_basename = 'simpleschemadoc'
...
latex_documents = [
    (master_doc, 'simpleschema.tex',
     u'simpleschema Documentation',
